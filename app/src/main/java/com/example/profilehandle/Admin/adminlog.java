package com.example.profilehandle.Admin;
...
import com.example.profilehandle.Categories.addcategory;
import com.example.profilehandle.R;
import com.example.profilehandle.dashboard;
                ...
                firebaseAuth.signInWithEmailAndPassword(username.getEditText().getText().toString(),
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(task.isSuccessful()){
                            startActivity(new Intent(adminlog.this, addcategory.class));
                        }
                        else{
