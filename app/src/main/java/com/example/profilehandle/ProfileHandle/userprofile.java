package com.example.profilehandle.ProfileHandle;
...
import com.example.profilehandle.session.sessionManager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                sessionManager sessionManager = new sessionManager(userprofile.this, com.example.profilehandle.session.sessionManager.SESSION_REMEMBERME);
       ...
       showAllUserData();
        ...
        profile_category.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(), showusercategory.class));
                finish();
            }
        });
                ...
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if(task.isSuccessful())
                        {
                            ...
                            Toast.makeText(userprofile.this, "Product Added Successfully", Toast.LENGTH_SHORT).show();
                        }
                        else
                        {
